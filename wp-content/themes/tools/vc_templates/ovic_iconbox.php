...
if ( !class_exists( 'Ovic_Shortcode_Iconbox' ) ) {
	class Ovic_Shortcode_Iconbox extends Ovic_Shortcode
	{
		...
		public function output_html( $atts, $content = null )
		{
			...
			$link_icon['target'] = ( $link_icon['target'] ) ? trim($link_icon['target']) : '_self';
			?>
                ...
                <div class="iconbox-inner">
					<?php if ( $icon ): ?>
						<?php if ( $link_icon['url'] ) : ?>
                            <div class="icon">
                                <a href="<?php echo esc_url( $link_icon['url'] ); ?>" <?php if ($link_icon['url'] && $link_icon['url'] != '#'): ?> target="<?php echo esc_attr( $link_icon['target'] ); ?>" <?php endif; ?>>
