 ...
 */
?>
<?php if ( is_active_sidebar( 'shop-widget-area-after-main' ) ) : ?>
	<div class="sidebar col-lg-12 col-md-12 col-sm-12 shop-widget-area-after-main">
		<?php dynamic_sidebar( 'shop-widget-area-after-main' ); ?>
	</div><!-- .widget-area -->
<?php endif; ?>
<?php
