...
#	return set_page_title('#%title%# #%pa_tyre_width%#/#%pa_tyre_profile%# R#%pa_tyre_rim%#');
	return set_page_title($text.' #%pa_tyre_width%#/#%pa_tyre_profile%# R#%pa_tyre_rim%#');
    }
}
